...
namespace TsMap.Canvas {
    public partial class TileMapGeneratorForm : Form {
        public delegate void GenerateTileMapEvent( MapInfoType type,
                                                   string      exportPath,
                                                   int         startZoomLevel,
                                                   int         endZoomLevel,
                                                   bool        createTiles,
        ...
        public TileMapGeneratorForm( string lastTileMapPath, RenderFlags renderFlags ) {
            InitializeComponent();
            mapInfoType.Text                  = MapInfoType.Jagfx.ToString();
            mapInfoType.DataSource            = Enum.GetValues( typeof( MapInfoType ) );
        ...
        private void GenerateBtn_Click( object sender, EventArgs e ) {
            ...
            if ( res == DialogResult.OK ) {
                ...
                MapInfoType type;
                Enum.TryParse( mapInfoType.SelectedValue.ToString(), out type );
                GenerateTileMap( type,             folderBrowserDialog1.SelectedPath, startZoomLevel, endZoomLevel, GenTilesCheck.Checked,
