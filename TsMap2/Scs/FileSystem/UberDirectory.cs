...
public class UberDirectory {
    ...
    /// </summary>
    private readonly List< AnEntry > _entries = new();
    ...
    /// <summary>
    ///     Adds a new <see cref="AnEntry" /> for the current directory
    /// </summary>
    public void AddNewEntry( AnEntry entry ) {
        _entries.Add( entry );
    }
    ...
    public List< string > GetSubDirectoryNames() => _subDirectoryNames;
}