...
using TsMap.Jagfx.Domain.FileExporter.MapInfo;
using TsMap.Jagfx.Domain.Tiles;
...
namespace TsMap.Canvas {
    public partial class TsMapCanvas : Form {
        ...
        private void GenerateTileMap( MapInfoType type,
                                      int         startZoomLevel,
                                      int         endZoomLevel,
                                      string      exportPath,
                                      bool        createTiles,
            ...
            Task.Run( () => {
                    ...
                    if ( saveInfo || startZoomLevel == 0 ) {
                        ...
                        if ( saveInfo ) {
                            DefaultMapInfoFile tsMapInfo = MapInfoFactory.Generate( type, Store.Instance.Game, mapPadding, tileSize,
                                                                                    pos.X, pos.X + tileSize / zoom, pos.Y, pos.Y + tileSize / zoom,
                                                                                    startZoomLevel, endZoomLevel );
                            var tsMapInfoJsonFactory = new MapInfoJsonFactory( tsMapInfo );
                            tsMapInfoJsonFactory.Save();
        ...
        private void GenerateTileMapToolStripMenuItem_Click( object sender, EventArgs e ) {
            ...
            _tileMapGeneratorForm.GenerateTileMap +=
                  ...
                  renderFlags ) => // Called when export button is pressed in TileMapGeneratorForm
                {
                    ...
                    GenerateTileMap( type, startZoomLevel, endZoomLevel, exportPath, createTiles, ( exportFlags & ExportFlags.TileMapInfo ) == ExportFlags.TileMapInfo,
                                     renderFlags );
                };
        }
