...
internal class PathHelper {
    ...
    /// <param name="filePath"></param>
    /// <returns></returns>
    internal static string GetFileNameFromPath( string filePath ) => Path.GetFileName( filePath );
    ...
    /// <param name="filePath"></param>
    /// <returns></returns>
    internal static string GetFileNameWithoutExtensionFromPath( string filePath ) => Path.GetFileNameWithoutExtension( filePath );
}